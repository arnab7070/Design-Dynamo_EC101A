      ...
      <div className="app__navbar-login">
        ...
        <a href="/" className="p__opensans">
          <a href="#_" class="relative inline-block text-lg group">
            ...
            <span
              class="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-yellow-900 rounded-lg group-hover:mb-0 group-hover:mr-0"
              data-rounded="rounded-lg"
            ></span>
          </a>
        </a>
